...
\begin{figure}[t]
  \centering
  % TODO: replace with generated samples at increasing training steps.
  \fbox{\parbox[c][3cm][c]{0.9\linewidth}{\centering Placeholder: generated
  samples at increasing training steps.}}
  \caption{Qualitative progression of generated floorplans over training. (To be
  added.)}
