"""Utilities for respacing diffusion timesteps.

Ported from ``external/house_diffusion/house_diffusion/respace.py`` with
identical behaviour.  Only import paths and style were adjusted.
"""
...
def space_timesteps(num_timesteps: int, section_counts: str | list[int]) -> set[int]:
    ...
    Args:
        ...
        section_counts: Either a list of numbers, or a string containing
            ...
            As a special case, use "ddimN" where N is a number of steps to
            use the striding from the DDIM paper.
